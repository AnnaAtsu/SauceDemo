...
public class ProductsChainOfInvicationTest extends BaseTest{
    ...
    public void checkAddButtonChangeToRemove() {
        ...
        productsPage = loginPage
                .open()
                .login("standard_user", "secret_sauce");
        String initialAddButtonText =
                productsPage.getButtonTextForProduct(productName);

        softAssert.assertEquals(
                initialAddButtonText,
                "Add to cart",
                "Не 'Add to cart'"
        );
        productsPage.addToCart(productName);
        String buttonTextAfterAdd =
                productsPage.getButtonTextForProduct(productName);
        ...
        String buttonTextAfterRemove =
                productsPage.getButtonTextForProduct(productName);

        softAssert.assertEquals(
                buttonTextAfterRemove,
                "Add to cart",
